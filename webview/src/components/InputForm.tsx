...
export const InputForm: React.FC<InputFormProps> = ({
    ...
    <div>
        ...
        <textarea
            ...
            rows={5}
            className="resize-none shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md bg-gray-800 text-white"
        ></textarea>
        ...
        <textarea
            ...
            rows={5}
            className="resize-none shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md mt-1 bg-gray-800 text-white"
        ></textarea>
